...
def _build_entity_text(entity: Union[Mapping[str, Any], Any], entity_type: str) -> str:
    ...
    if entity_type == "student":
        pieces.extend(
            [
                _extract_value(entity, "education_program"),
                _extract_value(entity, "subdivision"),
                _extract_value(entity, "direction"),
                _extract_value(entity, "status"),
                _extract_value(entity, "course"),
                _extract_value(entity, "group_number"),
                _extract_value(entity, "skills"),
                _extract_value(entity, "skills_to_learn"),
                _extract_value(entity, "interests"),
                _extract_value(entity, "dislikes"),
                _extract_value(entity, "achievements"),
                _extract_value(entity, "team_role"),
                _extract_value(entity, "commercial_experience"),
                _extract_value(entity, "noncommercial_experience"),
                _extract_value(entity, "portfolio"),
                _extract_value(entity, "hobbies"),
                _extract_value(entity, "dev_track"),
                _extract_value(entity, "science_track"),
                _extract_value(entity, "startup_track"),
                _extract_value(entity, "customer_discovery_level"),
                _extract_value(entity, "sales_level"),
                _extract_value(entity, "tech_execution_level"),
                _extract_value(entity, "data_analytics_level"),
                _extract_value(entity, "marketing_design_level"),
                _extract_value(entity, "finance_business_level"),
                _extract_value(entity, "team_leadership_level"),
                _extract_value(entity, "apply_master"),
                _extract_value(entity, "hours_per_week"),
                _extract_value(entity, "thematic_choice"),
